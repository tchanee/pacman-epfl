...
public class Wall extends AreaEntity {
	...
	/**
	 * Build a Wall from its position and its neighborhood. The neighborhood allows
	 * to select the sprite, it is a 3x3 matrix that indicate if a wall is present
	 * in the neighborhood, the center corresponds to the current wall position
	 * 
