...
public class Background extends Entity {
    ...
    public Background(Area area, String name) {
        super(DiscreteCoordinates.ORIGIN.toVector());
        sprite = new ImageGraphics(ResourcePath.getBackgrounds(name), area.getWidth(), area.getHeight(), null, Vector.ZERO, 1.0f, -Float.MAX_VALUE);
        sprite.setParent(this);
    }
